...
import bestExpressions_L_BC_EMOTION_LASSO_1 as emotion		
import bestExpressions_L_BC_GAMBLING_LASSO_1 as gambling	
import bestExpressions_L_BC_LANGUAGE_LASSO_1 as language		
import bestExpressions_L_BC_MOTOR_LASSO_1 as motor		
import bestExpressions_L_BC_RELATIONAL_LASSO_1 as relational		
import bestExpressions_L_BC_SOCIAL_LASSO_1 as social
import bestExpressions_L_BC_WM_LASSO_1 as wm
...
np.savetxt('msEmat_L_RL-BC_LASSO_1.csv', matrixMSE, delimiter=",")
np.savetxt('abEmat_L_RL-BC_LASSO_1.csv', matrixABE, delimiter=",")
np.savetxt('minmat_L_RL-BC_LASSO_1.csv', matrixMIN, delimiter=",")
