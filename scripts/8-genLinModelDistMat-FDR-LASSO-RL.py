...
import bestExpressions_L_FDR_EMOTION_LASSO_1 as emotion		
import bestExpressions_L_FDR_GAMBLING_LASSO_1 as gambling	
import bestExpressions_L_FDR_LANGUAGE_LASSO_1 as language		
import bestExpressions_L_FDR_MOTOR_LASSO_1 as motor		
...
np.savetxt('msEmat_L_RL-FDR_LASSO_1.csv', matrixMSE, delimiter=",")
np.savetxt('abEmat_L_RL-FDR_LASSO_1.csv', matrixABE, delimiter=",")
np.savetxt('minmat_L_RL-FDR_LASSO_1.csv', matrixMIN, delimiter=",")
