...
import bestExpressions_L_BC_EMOTION as emotion		
import bestExpressions_L_BC_GAMBLING as gambling	
import bestExpressions_L_BC_LANGUAGE as language		
import bestExpressions_L_BC_MOTOR as motor		
import bestExpressions_L_BC_RELATIONAL as relational		
import bestExpressions_L_BC_SOCIAL as social
import bestExpressions_L_BC_WM as wm
...
np.savetxt('msEmat_L_RL-BC.csv', matrixMSE, delimiter=",")
np.savetxt('abEmat_L_RL-BC.csv', matrixABE, delimiter=",")
np.savetxt('minmat_L_RL-BC.csv', matrixMIN, delimiter=",")
