...
import bestExpressions_L_FDR_EMOTION as emotion		
import bestExpressions_L_FDR_GAMBLING as gambling	
import bestExpressions_L_FDR_LANGUAGE as language		
import bestExpressions_L_FDR_MOTOR as motor		
import bestExpressions_L_FDR_RELATIONAL as relational		
import bestExpressions_L_FDR_SOCIAL as social
import bestExpressions_L_FDR_WM as wm
...
np.savetxt('msEmat_L_RL-FDR.csv', matrixMSE, delimiter=",")
np.savetxt('abEmat_L_RL-FDR.csv', matrixABE, delimiter=",")
np.savetxt('minmat_L_RL-FDR.csv', matrixMIN, delimiter=",")
