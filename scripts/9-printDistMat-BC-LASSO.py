...
iFile =  csv.reader(open('abEmat_L_LR-BC_LASSO_1.csv', 'r'))
...
iFile =  csv.reader(open('msEmat_L_LR-BC_LASSO_1.csv', 'r'))
mseMat = []
for l in iFile:
	mseMat.append(l)
...
iFile =  csv.reader(open('minmat_L_LR-BC_LASSO_1.csv', 'r'))
